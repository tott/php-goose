...
class Article {
	...
	/**
	 * Meta Sections field in the HTML source
	 *
	 * @var string
	 */
	protected $metaSections;

	/** @param string $metaSections */
	public function setMetaSections( $metaSections ) {
		$this->metaSections = $metaSections;
	}

	/** @return string */
	public function getMetaSections() {
		return $this->metaSections;
	}
